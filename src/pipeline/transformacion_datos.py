...
-----------------------
Funciones para transformar y estructurar datos históricos para análisis y cálculos técnicos.
Incluye validaciones, manejo de columnas y conversión eficiente.
"""
...
def transformar_datos(datos):
    ...
    Devuelve un DataFrame limpio y listo para análisis.
    """
...
# --- FUNCIÓN NO USADA ACTUALMENTE EN EL FLUJO PRINCIPAL ---
def estructurar_datos(datos):
    """
    [NO USADA] Extrae listas de valores clave para los cálculos de indicadores.
    Devuelve listas de highs, lows, closes y prices.

    Nota: Actualmente no se utiliza en el flujo principal del bot.
    Puedes eliminarla, moverla a utilidades, o dejarla para futuras extensiones.
    """
    if not datos:
